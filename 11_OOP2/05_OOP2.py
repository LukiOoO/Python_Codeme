# 5▹ Stwórz abstrakcyjną klasę Pojazdy. Utwórz potomne klasy pojazdy np. Samochód, Rower, Autobus, Ciężarówki. Dodaj opisy zgodne z tym jak te pojazdy są klasyfikowane.
